...
def _assert_not_shallow(request):
    if request.shallow:
        raise RuntimeError(
            "A shallow request tried to consume "
...
class BaseRequest(object):
    ...
    is_secure = property(
        lambda x: x.environ["wsgi.url_scheme"] == "https",
...
class CommonResponseDescriptorsMixin(object):
    ...
    del _set_property, _get_mimetype, _set_mimetype, _get_retry_after, _set_retry_after
