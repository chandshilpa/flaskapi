...
"""
from ...orm.properties import ColumnProperty, RelationshipProperty, SynonymProperty
...
def add_class(classname, cls):
    ...
    if classname in cls._decl_class_registry:
        ...
        if not isinstance(existing, _MultipleClassMarker):
            existing = cls._decl_class_registry[classname] = _MultipleClassMarker(
                [cls, existing]
            )
    else:
    ...
    try:
        ...
        cls._decl_class_registry["_sa_module_registry"] = root_module = _ModuleMarker(
    ...
    if isinstance(prop, RelationshipProperty):
        ...
        if prop.backref and isinstance(prop.backref, tuple):
            ...
            for attr in (
                ...
                if attr in kwargs and isinstance(kwargs[attr], util.string_types):
