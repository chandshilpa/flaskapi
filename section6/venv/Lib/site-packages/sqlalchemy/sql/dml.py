...
from .selectable import _interpret_as_from, _interpret_as_select, HasPrefixes, HasCTE
from .. import util
from .. import exc
...
class ValuesBase(UpdateBase):
    ...
    def __init__(self, table, values, prefixes):
        ...
        self.parameters, self._has_multi_parameters = self._process_colparams(values)
        if prefixes:
    ...
    def values(self, *args, **kwargs):
        ...
        if self.parameters is None:
            self.parameters, self._has_multi_parameters = self._process_colparams(v)
        else:
