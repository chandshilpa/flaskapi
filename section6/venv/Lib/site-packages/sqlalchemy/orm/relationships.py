...
class RelationshipProperty(StrategizedProperty):
    ...
    class Comparator(PropComparator):
        ...
        def __clause_element__(self):
            ...
            pj, sj, source, dest, secondary, target_adapter = self.property._create_joins(
                source_selectable=adapt_from, source_polymorphic=True, of_type=of_type
            )
            if sj is not None:
                return pj & sj
            else:
    ...
    def _optimized_compare(
        self, state, value_is_parent=False, adapt_source=None, alias_secondary=True
    ):
        ...
        if self.secondary is not None and alias_secondary:
            criterion = ClauseAdapter(self.secondary.alias()).traverse(criterion)
        ...
        for attr in "primaryjoin", "secondaryjoin":
            ...
            if val is not None:
                setattr(
                    self,
                    attr,
                    _orm_deannotate(expression._only_column_elements(val, attr)),
                )
