...
class CompositeProperty(DescriptorProperty):
    ...
    class CompositeBundle(query.Bundle):
        def __init__(self, property, expr):
            ...
            super(CompositeProperty.CompositeBundle, self).__init__(property.key, *expr)
    ...
    def set_parent(self, parent, init):
        if self.map_column:
            ...
            if self.key not in parent.mapped_table.c:
                ...
                and parent._columntoproperty[parent.mapped_table.c[self.key]].key
                == self.name
            ):
                raise sa_exc.ArgumentError(
...
class ComparableProperty(DescriptorProperty):
    ...
    def __init__(self, comparator_factory, descriptor=None, doc=None, info=None):
