...
from .deprecated_interfaces import MapperExtension, SessionExtension, AttributeExtension
from .util import (
    aliased,
    join,
    object_mapper,
...
@_sa_util.deprecated(
    "0.7",
    message=":func:`.compile_mappers` " "is renamed to :func:`.configure_mappers`",
)
def compile_mappers():
