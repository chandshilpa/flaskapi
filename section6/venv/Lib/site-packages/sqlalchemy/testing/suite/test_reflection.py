...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def setup_bind(cls):
        if config.requirements.independent_connections.enabled:
            ...
            return engines.testing_engine(options=dict(poolclass=pool.StaticPool))
        else:
            return config.db
    ...
    def define_temp_tables(cls, metadata):
        ...
        if testing.against("oracle"):
            kw = {"prefixes": ["GLOBAL TEMPORARY"], "oracle_on_commit": "PRESERVE ROWS"}
        else:
    ...
    def test_get_view_names_with_schema(self):
        self._test_get_table_names(testing.config.test_schema, table_type="view")
    ...
    def _type_round_trip(self, *types):
        ...
        return [c["type"] for c in inspect(self.metadata.bind).get_columns("t")]
    ...
    def test_get_view_columns_with_schema(self):
        self._test_get_columns(schema=testing.config.test_schema, table_type="view")
