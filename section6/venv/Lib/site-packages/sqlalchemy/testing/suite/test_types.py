...
class _UnicodeFixture(_LiteralRoundTripFixture):
    ...
    def test_round_trip_executemany(self):
        ...
        config.db.execute(
            unicode_table.insert(), [{"unicode_data": self.data} for i in range(3)]
        )
...
class NumericTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    def test_numeric_null_as_float(self):
        self._do_test(Numeric(precision=8, scale=4, asdecimal=False), [None], [None])
    ...
    def test_numeric_no_decimal(self):
        ...
        self._do_test(Numeric(precision=5, scale=3), numbers, numbers, check_scale=True)
...
class JSONTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def _test_round_trip(self, data_element):
        ...
        config.db.execute(data_table.insert(), {"name": "row1", "data": data_element})
    ...
    def test_round_trip_none_as_sql_null(self):
        ...
        with config.db.connect() as conn:
            conn.execute(self.tables.data_table.insert(), {"name": "r1", "data": None})
    ...
    def test_crit_against_string_coerce_type(self):
        ...
        self._test_index_criteria(
            and_(
                name == "r6", cast(col["b"], String) == type_coerce("some value", JSON)
            ),
            "r6",
            test_literal=False,
        )
