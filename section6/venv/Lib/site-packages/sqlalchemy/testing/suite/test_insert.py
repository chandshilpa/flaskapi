...
class LastrowidTest(fixtures.TablesTest):
    ...
    def test_last_inserted_id(self):
        ...
        r = config.db.execute(self.tables.autoinc_pk.insert(), data="some data")
...
class InsertBehaviorTest(fixtures.TablesTest):
    ...
    def test_insert_from_select(self):
        ...
        eq_(
            config.db.execute(select([table.c.data]).order_by(table.c.data)).fetchall(),
...
class ReturningTest(fixtures.TablesTest):
    ...
    def test_explicit_returning_pk_autocommit(self):
        ...
        r = engine.execute(table.insert().returning(table.c.id), data="some data")
        pk = r.first()[0]
    ...
    def test_explicit_returning_pk_no_autocommit(self):
        ...
        with engine.begin() as conn:
            r = conn.execute(table.insert().returning(table.c.id), data="some data")
            pk = r.first()[0]
        fetched_pk = config.db.scalar(select([table.c.id]))
        eq_(fetched_pk, pk)
