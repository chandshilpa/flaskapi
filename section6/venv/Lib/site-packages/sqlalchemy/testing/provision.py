...
def _mysql_create_db(cfg, eng, ident):
    with eng.connect() as conn:
        ...
        conn.execute("CREATE DATABASE %s_test_schema CHARACTER SET utf8mb3" % ident)
        conn.execute("CREATE DATABASE %s_test_schema_2 CHARACTER SET utf8mb3" % ident)
...
def _mssql_create_db(cfg, eng, ident):
    with eng.connect().execution_options(isolation_level="AUTOCOMMIT") as conn:
        ...
        conn.execute("ALTER DATABASE %s SET ALLOW_SNAPSHOT_ISOLATION ON" % ident)
        conn.execute("ALTER DATABASE %s SET READ_COMMITTED_SNAPSHOT ON" % ident)
