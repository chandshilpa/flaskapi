...
class _ConnectionRecord(object):
    ...
    def checkout(cls, pool):
        ...
        rec.fairy_ref = weakref.ref(
            fairy,
            lambda ref: _finalize_fairy and _finalize_fairy(None, rec, pool, ref, echo),
        )
        _refs.add(rec)
        if echo:
    ...
    def invalidate(self, e=None, soft=False):
        ...
        if e is not None:
            ...
            self.__pool.logger.info(
                "%sInvalidate connection %r", "Soft " if soft else "", self.connection
            )
        if soft:
...
def _finalize_fairy(connection, connection_record, pool, ref, echo, fairy=None):
    ...
    if connection is not None:
        ...
        try:
            fairy = fairy or _ConnectionFairy(connection, connection_record, echo)
